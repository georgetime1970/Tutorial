...
| structuredClone(value) | function | 深度结构化克隆（支持循环、Map、Date 等）   |
...
| Object.entries()                          | function |         | 返回 [key,value] 数组                    |
...
| Object.isSealed()                         | function |         | 判断对象是否已密封                       |
| Object.freeze()                           | function |         | 浅冻结                                   |
| Object.isFrozen()                         | function |         | 判断对象是否已冻结                       |
