    ...
    sidebar: {
      ...
      '/tutorial/JavaScript_My/': [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: '第一天', link: '/tutorial/JavaScript_My/6_WebApis第一天' },
            { text: '第二天', link: '/tutorial/JavaScript_My/7_WebApis第二天' },
            { text: '第三天', link: '/tutorial/JavaScript_My/8_WebApis第三天' },
            { text: '第四天', link: '/tutorial/JavaScript_My/9_WebApis第四天' },
            { text: '第五天', link: '/tutorial/JavaScript_My/10_WebApis第五天' },
            { text: '第六天', link: '/tutorial/JavaScript_My/11_WebApis第六天' },
