const directory = [
  {
    ...
    items: [
      ...
      { text: "所有权", link: "/tutorial/Rust/5.1.所有权" },
      { text: "所有权延申", link: "/tutorial/Rust/5.2.所有权延申" },
      { text: "Slice切片", link: "/tutorial/Rust/5.3.Slice切片" },
      { text: "struct结构体", link: "/tutorial/Rust/6.struct结构体" },
      { text: "enum枚举", link: "/tutorial/Rust/7.enum枚举" },
      { text: "match模式匹配", link: "/tutorial/Rust/8.1.match模式匹配" },
      { text: "模式与模式匹配", link: "/tutorial/Rust/8.2.模式与模式匹配" },
      { text: "模块系统", link: "/tutorial/Rust/9.模块系统" },
      { text: "vector向量", link: "/tutorial/Rust/10.vector向量" },
      { text: "String字符串", link: "/tutorial/Rust/11.1.String字符串" },
      { text: "String延申", link: "/tutorial/Rust/11.2.String延申" },
      { text: "HashMap哈希表", link: "/tutorial/Rust/12.哈希map" },
      { text: "错误处理", link: "/tutorial/Rust/13.错误处理" },
      { text: "泛型", link: "/tutorial/Rust/14.1.泛型" },
      { text: "Trait特征", link: "/tutorial/Rust/14.2.Trait特征" },
      ...
      { text: "Macro宏", link: "/tutorial/Rust/27.1.Macro宏" },
    ],
  },
];
